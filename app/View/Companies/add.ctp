	...
	<div class="row-fluid">
		<?php echo $this->Form->create('Company', array('class' => 'form-horizontal')); ?>
			...
			<div class="control-group">
				...
				<div class="controls">
					<?php echo $this->Form->input('Company.name', array('div' => false, 'label' => false, 'required' => 'required', 'class' => 'input-xlarge')); ?>
				</div>
			</div>
			<div class="control-group">
				<?php echo $this->Form->label('Company.contact_name', '* Contato: ', array("class" => 'control-label')); ?>
				<div class="controls">
					<?php echo $this->Form->input('Company.contact_name', array('div' => false, 'label' => false, 'required' => 'required', 'class' => 'input-xlarge')); ?>
				</div>
			</div>
			<div class="control-group">
				<?php echo $this->Form->label('Company.contact_email', '* E-mail: ', array("class" => 'control-label')); ?>
				<div class="controls">
					<?php echo $this->Form->input('Company.contact_email', array('div' => false, 'label' => false, 'required' => 'required', 'class' => 'input-xlarge')); ?>
				</div>
			</div>
			<div class="control-group">
				<?php echo $this->Form->label('Company.contact_telephone', '* Telefone: ', array("class" => 'control-label')); ?>
				<div class="controls">
					<?php echo $this->Form->input('Company.contact_telephone', array('div' => false, 'label' => false, 'required' => 'required', 'class' => 'input-xlarge')); ?>
				</div>
			</div>
			<div class="control-group">
			...
			<div class="control-group">
				...
				<div class="controls">
					<?php echo $this->Form->input('Company.cnpj', array('div' => false, 'label' => false, 'required' => 'required', 'class' => 'input-xlarge')); ?>
				</div>
			</div>
			<div class="control-group">
				<?php echo $this->Form->label('Company.state_inscription', 'Inscrição estadual: ', array("class" => 'control-label')); ?>
				<div class="controls">
					<?php echo $this->Form->input('Company.state_inscription', array('div' => false, 'label' => false, 'class' => 'input-xlarge')); ?>
				</div>
			</div>
			<div class="control-group">
				<?php echo $this->Form->label('Company.city_inscription', 'Inscrição municipal: ', array("class" => 'control-label')); ?>
				<div class="controls">
					<?php echo $this->Form->input('Company.city_inscription', array('div' => false, 'label' => false, 'class' => 'input-xlarge')); ?>
				</div>
			</div>
