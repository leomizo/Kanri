		...
		<div class="container">
			<ul id="context-options" class="nav">
				<li <?php if ($step == 0) echo 'class="active"'; ?>>
					<?php echo $this->Html->link('Dados pessoais', array('action' => 'new_edit', '?' => array('step' => 0), $this->request->data['Candidate']['id'])); ?>
				</li>
				<li <?php if ($step == 1) echo 'class="active"'; ?>>
					<?php echo $this->Html->link('Formação acadêmica', array('action' => 'new_edit', '?' => array('step' => 1), $this->request->data['Candidate']['id'])); ?>
				</li>
				<li <?php if ($step == 2) echo 'class="active"'; ?>>
					<?php echo $this->Html->link('Idiomas', array('action' => 'new_edit', '?' => array('step' => 2), $this->request->data['Candidate']['id'])); ?>
				</li>
				<li <?php if ($step == 3) echo 'class="active"'; ?>>
					<?php echo $this->Html->link('Cursos / especializações', array('action' => 'new_edit', '?' => array('step' => 3), $this->request->data['Candidate']['id'])); ?>
				</li>
				<li <?php if ($step == 4) echo 'class="active"'; ?>>
					<?php echo $this->Html->link('Remuneração', array('action' => 'new_edit', '?' => array('step' => 4), $this->request->data['Candidate']['id'])); ?>
				</li>
				<li <?php if ($step == 5) echo 'class="active"'; ?>>
					<?php echo $this->Html->link('Realizações', array('action' => 'new_edit', '?' => array('step' => 5), $this->request->data['Candidate']['id'])); ?>
				</li>
				<li <?php if ($step == 6) echo 'class="active"'; ?>>
					<?php echo $this->Html->link('Outras informações e Currículo', array('action' => 'new_edit', '?' => array('step' => 6), $this->request->data['Candidate']['id'])); ?>
				</li>
			</ul>
		</div>
	</div>
