	...
	<div class="row-fluid">
		<div class="span12">
			<form class="form-search well search-box">
				...
				<a href="candidate_add.html" class="btn btn-success pull-right"><i class="icon-plus icon-white"></i> Adicionar novo candidato</a>
		...
		<table class="table table-striped table-bordered">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<?php echo $candidate['Candidate']['location']; ?>
					</td>
					<td>
