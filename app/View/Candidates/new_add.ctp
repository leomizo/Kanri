	...
	<div class="navbar-inner">
		<div class="container">
			<ul id="context-options" class="nav">
				<li class='active'>
					<a href='#' style='cursor: default' onclick='return false'>Dados pessoais</a>
				</li>
				<li>
					<a href='#' style='cursor: default' onclick='return false'>Formação acadêmica</a>
				</li>
				<li>
					<a href='#' style='cursor: default' onclick='return false'>Idiomas</a>
				</li>
				<li>
					<a href='#' style='cursor: default' onclick='return false'>Cursos / especializações</a>
				</li>
				<li>
					<a href='#' style='cursor: default' onclick='return false'>Remuneração</a>
				</li>
				<li>
					<a href='#' style='cursor: default' onclick='return false'>Realizações</a>
				</li>
				<li>
					<a href='#' style='cursor: default' onclick='return false'>Comentários e Currículo</a>
				</li>
			</ul>
		</div>
	</div>
...
<div class="content-block container-fluid">
	...
	<div class="form-actions" style="padding-left: 20px">
		...
		echo $this->Html->link('Cancelar', array('action' => 'index'), array('class' => 'btn', 'style' => 'margin-left: 10px')); ?>
	</div>
