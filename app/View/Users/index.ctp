	...
	<div class="row-fluid">
		<div class="span12">
			...
			<?php echo $this->Form->create(null, array('class' => 'form-search well search-box', 'type' => 'get', 'action' => 'index'));
				  echo $this->Form->input("Buscar usuário: ", array('div' => false, 'class' => 'input-large search-query', 'label' => array('class' => 'control-label'), 'name' => 'search', 'id' => 'search-input', 'value' => isset($this->request->query['search']) ? $this->request->query['search'] : ''));
